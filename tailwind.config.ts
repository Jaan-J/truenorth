  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'inner-soft': 'inset 0 2px 4px 0 hsl(var(--navy-900) / 0.05)',
      },
      ...
      backgroundImage: {
        ...
        'gradient-navy': 'linear-gradient(135deg, hsl(var(--navy-700)), hsl(var(--navy-600)))',
        'gradient-gold': 'linear-gradient(135deg, hsl(var(--gold-300)), hsl(var(--gold-500)))',
        'compass-pattern': 'url("data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 60L60 0\' stroke=\'%23C9A24D\' stroke-opacity=\'0.08\' fill=\'none\'/%3E%3C/svg%3E")',
      },
    },
  },
